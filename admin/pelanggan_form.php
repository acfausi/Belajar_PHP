...
$data_pelanggan = $obj_pelanggan->data_Pelanggan();
...
<form action="pelanggan_controller.php" method="POST">
      <div class="form-group row">
        ...
        <div class="col-8">
          <input id="kode_p" name="kode_p" type="text" class="form-control" value="<?= $prod['kode_p']?>">
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-8">
          <input id="tgl_lahir" name="tgl_lahir" type="date" class="form-control" value="<?= $prod['tgl_lahir']?>">
        </div>
      </div>
      <div class="form-group row">
        <label for="text5" class="col-4 col-form-label">Email</label> 
        <div class="col-8">
          <input id="email" name="email" type="email" class="form-control" value="<?= $prod['email']?>">
        </div>
      </div>
      <div class="form-group row">

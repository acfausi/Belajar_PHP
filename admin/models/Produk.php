...
class Produk{
    ...
    public function dataProduk() {
        $sql = "SELECT produk.*, jenis_produk.nama as Ket FROM produk INNER JOIN jenis_produk ON jenis_produk.id = produk.jenis_produk_id";
    ...
    public function getProduk($id){
        $sql = "SELECT produk.*, jenis_produk.nama as Ket FROM produk INNER JOIN
